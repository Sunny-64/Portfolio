                ...
                <>
                    ...
                    <div className="w-full sm:w-2/5 md:px-2 sm:py-10">
                        <div className="flex flex-col w-full rounded-lg shadow border-[3px] border-verdigirls px-2 sm:px-4 py-5">
                            ...
                            <div className="text-cornsilk text-sm leading-6 sm:text-base">{item?.description}</div>
                        </div>
                    </div>
    ...
    return (
        <section id="timeline" className="p-5 py-10">
            <div className="flex justify-center gap-6 mb-16">
                <button className={`text-lg w-32  ${activeButton === 'EDUCATION' ? 'bg-gradient-to-br from-verdigirls from-30% to-cerulean to-70%' : 'hvr-bounce-to-right border-[2px] border-verdigirls'} px-5 py-2 rounded-sm shadow-sm`} onClick={() => setActiveButton('EDUCATION')}>
                    Education
                </button>
                <button className={`text-lg w-32 ${activeButton === 'EXPERIENCE' ? 'bg-gradient-to-br from-verdigirls from-30% to-cerulean to-70%' : 'border-[2px] border-verdigirls hvr-bounce-to-left '} px-5 py-2 rounded-sm shadow-sm`} onClick={() => setActiveButton('EXPERIENCE')}>
                    Experience
                </button>
            </div>
            ...
            <div className="min-h-screen ">
                <div className="min-h-screen flex justify-center">
                    <div className="lg:w-2/3 w-full mx-auto">{activeButton === 'EDUCATION' ? <RenderTimelineData data={EDUCATION} /> : <RenderTimelineData data={EXPERIENCE} />}</div>
                </div>
            </div>
        </section>
    );
