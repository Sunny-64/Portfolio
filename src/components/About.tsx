...
const About = () => {
    return (
        <section id="about" className="min-h-screen py-5 flex items-center">
            <div className="w-[90%] h-full mx-auto rounded-md px-5 py-8 md:py-16 bg-gradient-to-br from-cerulean to-rich-black shadow-lg">
                <div className="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="lg:col-span-2 xl:px-20 py-2 md:py-6">
